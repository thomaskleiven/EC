...
set CLASSPATH=%APP_HOME%\lib\Java.jar;%APP_HOME%\lib\commons-math3-3.6.1.jar

@rem Execute Java
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %JAVA_OPTS%  -classpath "%CLASSPATH%" TSP %CMD_LINE_ARGS%
