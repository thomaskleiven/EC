         ...
         try {
            ...
            // create the initial population of chromosomes
               ...
               while (generation < 100) {
                  ...
                  // double[] list1 = IntStream.range(0, chromosomes.length).mapToDouble(i -> chromosomes[i].getCost()).toArray();
                  ...
                  double[] discreteProbabilities = IntStream.range(0, chromosomes.length).mapToDouble(i -> (1.0 - chromosomes[i].getCost() / chromosomes[chromosomes.length-1].getCost())).toArray();
                  ...
                  Chromosome.sortChromosomes(chromosomes, populationSize);
                  // double[] list = IntStream.range(0, chromosomes.length).mapToDouble(i -> chromosomes[i].getCost()).toArray();
